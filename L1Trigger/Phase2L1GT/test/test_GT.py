...
process.maxEvents = cms.untracked.PSet(input=cms.untracked.int32(96)) # number of events
...
# process.load('L1Trigger.Phase2L1GT.test_exoticseeds_cff')
...
process.BoardDataInputVU9P.maxEvents = cms.untracked.uint32(96) # number of output events per file
process.BoardDataOutputObjectsVU9P.maxEvents = cms.untracked.uint32(96)  # number of output events per file
process.AlgoBitBoardDataVU9P.maxEvents = cms.untracked.uint32(96)  # number of output events per file
...
process.schedule = cms.Schedule(process.raw2digi_step,process.L1simulation_step,process.GTemulation_step, *collectAlgorithmPaths(process), process.pGToutput,
                                process.pBoardDataInputVU9P, process.pBoardDataOutputObjectsVU9P, process.pAlgoBitBoardDataVU9P, process.endjob_step)
